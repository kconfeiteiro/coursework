...
def benchmark(n=100, method='python'):
    ...
    if method == 'python':
       simulator.evolve_python(1)
    if method == 'numpy':
       simulator.evolve_numpy(1)
    if method == 'cython':
       simulator.evolve_cython(1)
    if method == 'openmp':
       simulator.evolve_openmp(1)
